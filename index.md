...
1.  **Stress Evolution:** Tracks how load accumulates and leaks.
2.  **Cascade Activation:** Defines the "trigger" when stress exceeds capacity.
3.  **Capacity Degradation:** Models "burnout"—the permanent structural damage taken during a crisis.
4.  **Homeostatic Adaptation:** The "hiring/firing" loop that keeps the system dangerously close to the edge.
...
**License:** [PolyForm Noncommercial 1.0.0](LICENCE.html).